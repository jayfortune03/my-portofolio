...
export const projects: Project[] = [
  ...
  },
  {
    ...
    stack: ["Next.js", "TypeScript", "NestJS", "PostgreSQL", "Material UI", "SSE"],
  },
  {
  ...
  },
  {
    ...
    stack: ["Vue 2", "Express", "Socket", "Firebase", "CapacitorJS", "PostgreSQL"],
  },
  {
    name: "AP2T / ACMT / RTR",
    ...
    stack: ["Vue 3", "Vite", "Module Federation", "Tailwind", "REST API", "JWT"],
  },
];
...
export const stackGroups: StackGroup[] = [
  {
    label: "Frontend",
    icon: "frontend",
    items: ["React", "Next.js", "Vue.js", "TypeScript", "Tailwind", "Material UI", "Ant Design Vue", "Vite"],
  },
  {
    label: "Backend",
    icon: "backend",
    items: ["Node.js", "Express.js", "NestJS", "Golang", "Gin", "REST API", "Clean Architecture"],
  },
  {
    label: "Mobile & Desktop",
    icon: "mobile",
    items: ["React Native", "CapacitorJS", "Electron", "Firebase Cloud Messaging"],
  },
  {
    label: "Cloud & Data",
    icon: "cloud",
    items: ["PostgreSQL", "PocketBase", "CouchDB", "GCP", "Docker", "Xendit", "JWT", "OAuth"],
  },
];
