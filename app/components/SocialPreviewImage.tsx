  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ maxWidth: 900, fontSize: 78, fontWeight: 900, letterSpacing: -1, lineHeight: 0.96 }}>
          Nicholas Fortune builds scalable product systems.
        </div>
        <div style={{ maxWidth: 930, color: "rgba(237, 247, 241, 0.74)", fontSize: 30, lineHeight: 1.35 }}>
